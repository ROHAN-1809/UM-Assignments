...
This repository contains the assignments completed during the **Unified Mentor Data Analysis Internship**. Each assignment focuses on a key aspect of data analysis and helps build practical skills using Python and industry-standard tools.

## Assignment Overview

* **Exploratory Data Analysis (EDA):** Performed data exploration, visualization, and insight generation to better understand datasets.
